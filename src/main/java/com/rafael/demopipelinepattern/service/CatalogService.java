...
public class CatalogService {
    ...
    public CatalogResponse get(final String itemId) {
        CompletableFuture<ItemResponse> itemFuture = CompletableFuture.supplyAsync(() -> itemService.getById(itemId));
        
        CompletableFuture<InventoryResponse> inventoryFuture = CompletableFuture.supplyAsync(() -> inventoryService.getByItemId(itemId));
        
        CompletableFuture<PromotionResponse> promotionFuture = CompletableFuture.supplyAsync(() -> promotionService.getByItemId(itemId));
