...
public class PipelineEngine {
    ...
    private void waitForCompletion(final Context context) {
        CompletableFuture.allOf(
                context.getFutures().values().toArray(new CompletableFuture[0])
        ).join();
    }
    ...
    private void scheduleAsyncStep(final Context context, final Step step, final CompletableFuture<Void> dependencies) {
    ...
    private void scheduleSyncStep(final Context context, final Step step, final CompletableFuture<Void> dependencies) {
